    ...
    >
      <div className="flex items-center gap-1">
        <Link
          to={path}
          className={cn(
            "text-sm font-medium transition-all hover:text-brand-accent py-2 flex items-center gap-1",
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-1 w-64 p-2 bg-brand-bg/95 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl z-[60]"
          >
