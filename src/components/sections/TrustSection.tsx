              ...
              {[...Array(3)].map((_, i) => (
                <div key={i} className="flex gap-16 md:gap-24 items-center">
                  {[
                    ...
                    { name: "GEWE Reifen & Räder Großhandel", url: "https://res.cloudinary.com/dzt4f9xdi/image/upload/q_auto,f_auto,w_200/v1784035840/imgi_3_gewe_white_bsh1xj.png" },
                    { name: "ASA Driving Revolution Felgen", url: "https://res.cloudinary.com/dzt4f9xdi/image/upload/q_auto,f_auto,w_200/v1784035840/asa-driving-revolution-vector-logo_beirxb.png" }
                  ].map((client, idx) => (
              ...
              {[...Array(3)].map((_, i) => (
                <div key={i} className="flex gap-16 md:gap-24 items-center">
                  {[
                    ...
                    { name: "TEC Speedwheels Felgen", url: "https://res.cloudinary.com/dzt4f9xdi/image/upload/q_auto,f_auto,w_200/v1784035840/tec_speedwheels_2017_white_nezbgd.png" }
                  ].map((client, idx) => (
                    <div key={`${client.name}-${idx}`} className="w-32 md:w-48 h-12 md:h-16 flex items-center justify-center grayscale opacity-75 hover:opacity-100 hover:grayscale-0 transition-all duration-500">
                      <img 
                        loading="lazy" src={client.url}
