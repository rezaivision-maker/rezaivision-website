            ...
            <div className="flex animate-marquee-left whitespace-nowrap gap-16 md:gap-24 items-center">
              {[...Array(3)].map((_, i) => (
                <div key={i} className="flex gap-16 md:gap-24 items-center">
                  {[
                    { name: "KSL", url: "https://res.cloudinary.com/dzt4f9xdi/image/upload/q_auto/f_auto/v1775650602/ksl_logo_header_25_xkxnfe.webp" },
                    { name: "Paff", url: "https://res.cloudinary.com/dzt4f9xdi/image/upload/q_auto/f_auto/v1775650428/Paff_LOGO_afp43m.webp" },
                    { name: "KSB Rechtsanwälte", url: "https://res.cloudinary.com/dzt4f9xdi/image/upload/q_auto/f_auto/v1775650320/KSB-Rechtsanwaelte_Logo_xr32rm.webp" },
                    ...
                    { name: "Social Care", url: "https://res.cloudinary.com/dzt4f9xdi/image/upload/q_auto/f_auto/v1775650095/socialcare-logo_d5acj2.webp" },
                    { name: "Shogun Gym", url: "https://res.cloudinary.com/dzt4f9xdi/image/upload/q_auto/f_auto/v1775650090/shogun_gym_tcwvyk.webp" },
                    { name: "Schlossgut Lüll", url: "https://res.cloudinary.com/dzt4f9xdi/image/upload/q_auto/f_auto/v1775650086/Schlossgut-Lull-01_-_weiss_lvq8cd.webp" }
                  ].map((client, idx) => (
          ...
          <div className="relative flex overflow-hidden">
            <div className="flex animate-marquee-right whitespace-nowrap gap-16 md:gap-24 items-center">
              {[...Array(3)].map((_, i) => (
                <div key={i} className="flex gap-16 md:gap-24 items-center">
                  {[
                    { name: "Fit for Drive", url: "https://res.cloudinary.com/dzt4f9xdi/image/upload/q_auto/f_auto/v1775650059/fitfordrive_m8sbug.webp" },
                    { name: "Folienritter", url: "https://res.cloudinary.com/dzt4f9xdi/image/upload/q_auto/f_auto/v1775650065/Folienritter_Logo_mzz194.webp" },
                    { name: "Aesthetic Ink", url: "https://res.cloudinary.com/dzt4f9xdi/image/upload/q_auto/f_auto/v1775650037/Aestethic_Ink_Weiss_250_px_gc2mh0.webp" },
                    { name: "Pflege mit Erfolg", url: "https://res.cloudinary.com/dzt4f9xdi/image/upload/q_auto/f_auto/v1775650081/Pflege_mit_Erfolg_yrjkmx.webp" },
                    { name: "Tanzschule Marquardt", url: "https://res.cloudinary.com/dzt4f9xdi/image/upload/q_auto/f_auto/v1775650076/logo_tanzschule_marquardt_znwhzr.webp" },
                    { name: "Cinelex Media", url: "https://res.cloudinary.com/dzt4f9xdi/image/upload/q_auto/f_auto/v1775650053/cinelex-media-logo-transparent-kaiserslautern_ueqzjq.webp" },
                    { name: "CBL", url: "https://res.cloudinary.com/dzt4f9xdi/image/upload/q_auto/f_auto/v1775650047/CBL_Logo_transparent_kkhdqm.png" }
                  ].map((client, idx) => (
                    <div key={`${client.name}-${idx}`} className="w-32 md:w-48 h-12 md:h-16 flex items-center justify-center grayscale opacity-40 hover:opacity-100 hover:grayscale-0 transition-all duration-500">
                      <img 
                        src={client.url} 
