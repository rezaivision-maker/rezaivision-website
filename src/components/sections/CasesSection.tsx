            ...
            <div className="grid grid-cols-1 lg:grid-cols-[35fr_65fr] gap-8 lg:gap-12 mt-4">
              ...
              <div className="grid grid-cols-2 grid-rows-2 gap-4 lg:gap-6">
                <div className="relative rounded-3xl overflow-hidden bg-brand-darker gold-border-glow">
                  <img loading="lazy" src="https://res.cloudinary.com/dzt4f9xdi/image/upload/q_auto/f_auto/v1775733154/Aestethic_Ink_Kaiserslautern__ppagfi.webp" alt="Aesthetic Ink Tattoo Studio Kaiserslautern — Social Media Video Ads Rezai Vision" className="w-full h-full object-cover transition-transform duration-700 ease-out hover:scale-105" referrerPolicy="no-referrer" />
                </div>
                <div className="relative rounded-3xl overflow-hidden bg-brand-darker gold-border-glow">
                ...
                <div className="relative rounded-3xl overflow-hidden bg-brand-darker gold-border-glow">
                  <img loading="lazy" src="https://res.cloudinary.com/dzt4f9xdi/image/upload/q_auto/f_auto/v1775734565/Ausethetik_INK_4_qnvksf.webp" alt="Aesthetic Ink Social Media Content Kaiserslautern — Werbefilm Beauty Branche" className="w-full h-full object-cover transition-transform duration-700 ease-out hover:scale-105" referrerPolicy="no-referrer" />
                </div>
                <div className="relative rounded-3xl overflow-hidden bg-brand-darker gold-border-glow">
                  <img loading="lazy" src="https://res.cloudinary.com/dzt4f9xdi/image/upload/q_auto/f_auto/v1775734141/AestethicInk_Kaiserslautern_2_h6yrms.webp" alt="Aesthetic Ink Werbevideo Kaiserslautern — Instagram Reels Tattoo Studio" className="w-full h-full object-cover transition-transform duration-700 ease-out hover:scale-105" referrerPolicy="no-referrer" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-2 gap-4 mt-2">
                ...
                <div className="grid grid-rows-2 gap-4">
                  <div className="relative rounded-3xl overflow-hidden bg-brand-darker gold-border-glow">
                    <img loading="lazy" src="https://res.cloudinary.com/dzt4f9xdi/image/upload/q_auto/f_auto/v1775737722/Behnke1_ao07wt.webp" alt="KSB Rechtsanwälte Social Media Content Kaiserslautern — Rezai Vision" className="w-full h-full object-cover transition-transform duration-700 ease-out hover:scale-105" referrerPolicy="no-referrer" />
                  </div>
                  <div className="relative rounded-3xl overflow-hidden bg-brand-darker gold-border-glow">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-[4fr_6fr] gap-4 mt-2">
                ...
                <div className="grid grid-cols-2 grid-rows-2 gap-4">
                  ...
                  <div className="relative rounded-3xl overflow-hidden bg-brand-darker gold-border-glow">
                    <img loading="lazy" src="https://res.cloudinary.com/dzt4f9xdi/image/upload/q_auto/f_auto/v1775810388/Adonay_welde_social_care_1.12.1_d3uhxu.webp" alt="Social Care Mitarbeiterstimmen Mainz — Authentisches Employer Branding" className="w-full h-full object-cover transition-transform duration-700 ease-out hover:scale-105" referrerPolicy="no-referrer" />
                  </div>
                  <div className="relative rounded-3xl overflow-hidden bg-brand-darker gold-border-glow">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-[4fr_6fr] gap-4 mt-2">
                ...
                <div className="grid grid-cols-2 grid-rows-2 gap-4">
                  <div className="relative rounded-3xl overflow-hidden bg-brand-darker gold-border-glow">
                    <img loading="lazy" src="https://res.cloudinary.com/dzt4f9xdi/image/upload/q_auto/f_auto/v1775741311/pfaff_4_1.8.2_emhgzd.webp" alt="Pfaff Nähmaschine Detail Produktfilm Kaiserslautern — Industrievideo Messe" className="w-full h-full object-cover transition-transform duration-700 ease-out hover:scale-105" referrerPolicy="no-referrer" />
                  </div>
                  <div className="relative rounded-3xl overflow-hidden bg-brand-darker gold-border-glow">
