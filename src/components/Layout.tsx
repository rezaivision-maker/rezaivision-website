          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            <div>
              ...
              <p className="text-gray-400 mb-6 max-w-xs text-sm leading-relaxed">
                Premium Videoproduktion mit Hauptsitz in Kaiserslautern. Wir produzieren Filme, Social Ads und Eventvideos im Umkreis von 100 km, inklusive Mannheim, Saarbrücken, Mainz und ganz Rheinland-Pfalz. Starke Arbeit verdient es, gesehen zu werden.
              </p>
            </div>
